	...
	*/
    ...
    jeDt.extend = function() {
        var _extend = function me(dest, source) {
            console.info("33333333333333333-1");
    ...
    var config = {
        ...
        console.info("11111111111111", that, that.config);
        that.init();
        console.info("11111111111111END");
    };
    ...
    InitDate.prototype = {
        init:function() {
            console.info("777777", this.config);
            var that = this;
            opts = that.config;
            console.info(QD(opts.dateCell));
            self = QD(opts.dateCell)[0];
            console.info(self);
            elem, devt, even = window.event, target;
            ...
            console.info("222222222222222222-1");
            console.info(self);
            if (opts.isinitVal) {
            ...
            console.info("222222222222222222-2");
